...
object Readme {
  val body = 
    <div id="read">
      ...
      <p>
        ls syncronizes your library build information with library version description file hosted on github, through a process called <code>lsyncing</code>. Lsyncing this information from sources publicly hosted on github means there is no need for authentications with ls's service.
      </p>
